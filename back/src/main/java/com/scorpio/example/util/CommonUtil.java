package com.scorpio.example.util;

import com.alibaba.fastjson.JSONObject;
import com.scorpio.example.config.exception.CommonJsonException;
import com.scorpio.example.model.entity.ArticleEntity;
import com.scorpio.example.util.constants.Constants;
import com.scorpio.example.util.constants.ErrorEnum;
...
public class CommonUtil {
	 ...
	 */
	public static JSONObject successPage(final JSONObject requestJson, List list, int totalCount) {
